...
V9_RESULTS_JS = r"""v9Results:{rendered:false,render(){
  ...
  sec.innerHTML='<h2>V9 Positive Control</h2>'
    ...
    +'<div class="v9-summary-lead"><div class="v9-summary-kicker">Operational headline</div><div class="v9-summary-title">Deployable Hybrid finds '+fmt(headlineDelta)+' more hidden carriers at K='+fmt(headlineK)+'.</div><div class="v9-summary-copy">'+fmt(headlineHybrid)+' found vs '+fmt(headlineBaseline)+' for the baseline ('+(headlineLift==null?'n/a':pct(headlineLift))+' lift). GNN ceiling: '+(headlineGnn==null?'n/a':fmt(headlineGnn))+'.</div><a class="v9-summary-link" href="#tab-explorer" data-navigate-tab="explorer">Explore the graph evidence →</a></div>'
    +'<div class="v9-summary-stat"><b>'+fmt(headlineHybrid)+'</b><span>Hybrid found</span></div>'
    +'<div class="v9-summary-stat"><b>'+fmt(headlineBaseline)+'</b><span>Baseline found</span></div>'
    +'<div class="v9-summary-stat"><b>'+(headlineGnn==null?'n/a':fmt(headlineGnn))+'</b><span>GNN ceiling</span></div>'
    +'</div>'
    ...
    +'<section class="v9-story" aria-labelledby="v9-story-title"><div class="v9-story-header"><div><div class="v9-story-kicker">How to read this tab</div><h3 id="v9-story-title" class="v9-story-title">Read the V9 result through three lenses</h3><p class="v9-story-intro">Each panel uses a different population or inspection budget.</p></div><div class="v9-story-note"><b>The short version</b>The graph advantage appears at operational depth.</div></div><div class="v9-lens-grid"><article class="v9-lens"><h4>1. Global ranking</h4><p>One whole-pool top-K list, with all hidden carriers in the recall denominator.</p><div class="v9-lens-stat"><b>'+fmt(wholeHybridAt2000)+' vs '+fmt(wholeBaselineAt2000)+'</b><span>Whole-pool hidden carriers found at K=2,000</span></div></article><article class="v9-lens"><h4>2. Findable depth</h4><p>Defaults to the '+fmt(demo.stratum_hidden.observable)+'-carrier observable slice. Toggle for the whole pool.</p><div class="v9-lens-stat"><b>'+fmt(headlineHybrid)+' vs '+fmt(headlineBaseline)+'</b><span>Hybrid vs baseline at K='+fmt(headlineK)+' in the selected population</span></div></article><article class="v9-lens"><h4>3. Daily operations</h4><p>Each of '+fmt(dailyDays)+' test days gets its own quota; 25/day equals '+fmt(dailyBudget25)+' inspections.</p><div class="v9-lens-stat"><b>'+fmt(dailyHybrid25)+' vs '+fmt(dailyBaseline25)+'</b><span>Hybrid vs baseline at 25 inspections/day</span></div></article></div></section>'
    ...
    +'<div class="v9-card"><h3>Depth Recall</h3><div class="v9-hint">Share of hidden carriers found in the selected population.</div><div id="v9-bars"></div></div>'
    ...
    +'<div class="v9-card" style="margin-top:18px"><h3>Daily Crossing Volume</h3><div class="v9-hint">Daily test-window crossing volume and hidden carriers found by each model.</div><div class="v9-chart-stack"><section class="v9-chart-block"><div class="v9-daily-found-header"><h4>Crossing events and hidden carriers found per day</h4><label><span class="v9-sr-only">Daily inspection budget</span><select id="v9-daily-found-k" class="v9-daily-found-select"></select></label></div><div class="v9-hint">Daily top-k finds only. Toggle a model to show or hide its line.</div><div id="v9-volume"></div></section><section id="v9-simulated-catches" class="v9-chart-block" aria-labelledby="v9-simulated-title"><div class="v9-daily-found-header"><h4 id="v9-simulated-title">Simulated catches — first-time recoveries</h4><label><span class="v9-sr-only">Simulated daily inspection budget</span><select id="v9-simulated-k" class="v9-daily-found-select"></select></label></div><div class="v9-hint">New people found each day after earlier simulated catches leave the candidate pool.</div><div id="v9-simulated-summary" class="v9-simulated-summary"></div><div id="v9-simulated-volume"></div></section></div></div>'
  ...
  function drawCombined(){
    ...
    const legend='<button type="button" class="v9-chart-toggle" data-layer="crossings" aria-pressed="true"><i class="v9-chart-key crossings"></i>Crossing events</button><button type="button" class="v9-chart-toggle" data-layer="hidden-carriers" aria-pressed="true"><i class="v9-chart-key hidden-carriers"></i>Hidden carriers</button>'+arms.map(a=>'<button type="button" class="v9-chart-toggle" data-arm="'+a+'" aria-pressed="true"><i class="v9-chart-key '+a+'"></i>'+esc(armLabel(a))+'</button>').join('');
    el.innerHTML='<div class="v9-volume-summary"><div class="v9-volume-stat"><b>'+fmt(points.length)+'</b><span>Days</span></div><div class="v9-volume-stat"><b>'+average.toFixed(1)+'</b><span>Average crossings / day</span></div><div class="v9-volume-stat"><b>'+fmt(peak)+'</b><span>Peak crossings / day</span></div></div><div class="v9-chart-legend" aria-label="Model and data-layer legend">'+legend+'</div><svg class="v9-combined-chart" viewBox="0 0 '+width+' '+height+'" role="img" aria-label="Daily crossing events and hidden carriers found"><text x="'+left+'" y="12">crossing events / day</text><text x="'+(width-right)+'" y="12" text-anchor="end">hidden carriers found / day</text>'+rules+rightLabels+'<g class="v9-crossings-layer" data-layer="crossings"><path class="v9-volume-area" d="'+volumeArea+'"/><path class="v9-volume-line" d="'+volumeLine+'"/>'+volumePoints+'</g><line class="v9-hover-guide" x1="'+left+'" x2="'+left+'" y1="'+top+'" y2="'+(top+chartH)+'"/><g class="v9-hidden-carriers-layer" data-layer="hidden-carriers">'+modelLines+modelPoints+'</g>'+ticks+'<rect class="v9-hover-target" x="'+left+'" y="'+top+'" width="'+chartW+'" height="'+chartH+'"/></svg>';
