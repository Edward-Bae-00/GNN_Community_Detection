...
The execution guidance in this historical plan is superseded by [`tasks/v9_observability_completion_plan.md`](v9_observability_completion_plan.md). Use its K=5 production command, checkpoint resume path, fail-closed Gemma requirements, verification gates, and release checklist. Do not use the stale daily-25, bounded-explanation, or deterministic-template commands that previously appeared here.
